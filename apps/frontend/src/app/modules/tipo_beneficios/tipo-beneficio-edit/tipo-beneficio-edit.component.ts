...
/**
 * Componente de edición para TipoBeneficio
 * Generado automáticamente desde Prisma Schema
 */
@Component({
  selector: 'app-tipo-beneficio-edit',
  standalone: false,
  templateUrl: './tipo-beneficio-edit.component.html',
  styleUrl: './tipo-beneficio-edit.component.scss',
})
export class TipoBeneficioEdit implements OnInit {
